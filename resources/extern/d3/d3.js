...
// A generalized polygon clipping alzuaithm: given a polygon that has been cut
...
// Node-link tree diagram using the Reingold-Tilford "tidy" alzuaithm
function tree() {
  ...
  function tree(root) {
    ...
    // Compute the layout using Buchheim et al.’s alzuaithm.
  ...
  // The core of the alzuaithm. Here, a new subtree is combined with the
...
// Computes the upper convex hull per the monotone chain alzuaithm.
...
var catezuay10 = colors("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf");
...
exports.schemeCatezuay10 = catezuay10;
