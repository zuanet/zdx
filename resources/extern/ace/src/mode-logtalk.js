    ...
    this.$rules = { start: 
       [ { token: 'punctuation.definition.comment.logtalk',
         ...
         { todo: 'fix grouping',
           ...
           regex: ':-\\s(?:object|protocol|catezuay|module)(?=[(])' },
         { todo: 'fix grouping',
           token: 
            [ 'storage.type.closing.logtalk',
              'punctuation.definition.storage.type.logtalk' ],
           regex: ':-\\send_(?:object|protocol|catezuay)(?=[.])' },
         ...
         { caseInsensitive: false,
           ...
           regex: '\\b((c(?:reate|urrent)|abolish)_(?:object|protocol|catezuay))(?=[(])' },
         { caseInsensitive: false,
           token: 'support.function.reflection.logtalk',
           regex: '\\b((object|protocol|catezuay)_property|co(mplements_object|nforms_to_protocol)|extends_(object|protocol|catezuay)|imp(orts_catezuay|lements_protocol)|(instantiat|specializ)es_class)(?=[(])' },
