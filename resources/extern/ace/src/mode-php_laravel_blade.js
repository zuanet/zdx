...
grapheme_stristr|grapheme_strlen|grapheme_strpos|grapheme_strripos|grapheme_strrpos|grapheme_strstr|grapheme_substr|grezuaiantojd|\
...
jddayofweek|jdmonthname|jdtofrench|jdtogrezuaian|jdtojewish|jdtojulian|jdtounix|jewishtojd|join|jpeg2wbmp|json_decode|json_encode|\
...
mcrypt_enc_get_alzuaithms_name|mcrypt_enc_get_block_size|mcrypt_enc_get_iv_size|mcrypt_enc_get_key_size|mcrypt_enc_get_modes_name|\
mcrypt_enc_get_supported_key_sizes|mcrypt_enc_is_block_alzuaithm|mcrypt_enc_is_block_alzuaithm_mode|mcrypt_enc_is_block_mode|\
...
mcrypt_get_cipher_name|mcrypt_get_iv_size|mcrypt_get_key_size|mcrypt_list_alzuaithms|mcrypt_list_modes|mcrypt_module_close|\
mcrypt_module_get_algo_block_size|mcrypt_module_get_algo_key_size|mcrypt_module_get_supported_key_sizes|mcrypt_module_is_block_alzuaithm|\
mcrypt_module_is_block_alzuaithm_mode|mcrypt_module_is_block_mode|mcrypt_module_open|mcrypt_module_self_test|mcrypt_ofb|md5|md5_file|\
...
mongomaxkey|mongominkey|monzuaegex|mongotimestamp|move_uploaded_file|mpegfile|mqseries_back|mqseries_begin|mqseries_close|mqseries_cmit|\
...
var functionMap = {
    ...
    "base64_decode": [
        ...
        "Decodes string using MIME base64 alzuaithm"
    ],
    "base64_encode": [
        "string base64_encode(string str)",
        "Encodes string using MIME base64 alzuaithm"
    ],
    "base_convert": [
    ...
    "checkdate": [
        ...
        "Returns true(1) if it is a valid date in grezuaian calendar"
    ],
    "chgrp": [
    ...
    "dcgettext": [
        "string dcgettext(string domain_name, string msgid, long catezuay)",
        "Return the translation of msgid for domain_name and catezuay, or msgid unaltered if a translation does not exist"
    ],
    "dcngettext": [
        "string dcngettext (string domain, string msgid1, string msgid2, int n, int catezuay)",
    ...
    "get_defined_constants": [
        "array get_defined_constants([bool catezuaize])",
    ...
    "gmp_divexact": [
        ...
        "Divide a by b using exact division alzuaithm"
    ],
    "gmp_fact": [
    ...
    "grezuaiantojd": [
        "int grezuaiantojd(int month, int day, int year)",
        "Converts a grezuaian calendar date to julian day count"
    ],
    "gzcompress": [
    ...
    "hash_algos": [
        ...
        "Return a list of registered hashing alzuaithms"
    ],
    "hash_copy": [
    ...
    "jdtogrezuaian": [
        "string jdtogrezuaian(int juliandaycount)",
        "Converts a julian day count to a grezuaian calendar date"
    ],
    "jdtojewish": [
    ...
    "locale_filter_matches": [
        ...
        "* Checks if a $langtag filter matches with $locale according to RFC 4647's basic filtering alzuaithm"
    ],
    ...
    "mcrypt_enc_get_alzuaithms_name": [
        "string mcrypt_enc_get_alzuaithms_name(resource td)",
        "Returns the name of the alzuaithm specified by the descriptor td"
    ],
    ...
    "mcrypt_enc_get_iv_size": [
        ...
        "Returns the size of the IV in bytes of the alzuaithm specified by the descriptor td"
    ],
    "mcrypt_enc_get_key_size": [
        "int mcrypt_enc_get_key_size(resource td)",
        "Returns the maximum supported key size in bytes of the alzuaithm specified by the descriptor td"
    ],
    ...
    "mcrypt_enc_is_block_alzuaithm": [
        "bool mcrypt_enc_is_block_alzuaithm(resource td)",
        "Returns TRUE if the alrogithm is a block alzuaithms"
    ],
    "mcrypt_enc_is_block_alzuaithm_mode": [
        "bool mcrypt_enc_is_block_alzuaithm_mode(resource td)",
        "Returns TRUE if the mode is for use with block alzuaithms"
    ],
    ...
    "mcrypt_enc_self_test": [
        ...
        "This function runs the self test on the alzuaithm specified by the descriptor td"
    ],
    "mcrypt_encrypt": [
    ...
    "mcrypt_list_alzuaithms": [
        "array mcrypt_list_alzuaithms([string lib_dir])",
        "List all alzuaithms in \"module_dir\""
    ],
    "mcrypt_list_modes": [
    ...
    "mcrypt_module_get_algo_block_size": [
        "int mcrypt_module_get_algo_block_size(string alzuaithm [, string lib_dir])",
        "Returns the block size of the alzuaithm"
    ],
    "mcrypt_module_get_algo_key_size": [
        "int mcrypt_module_get_algo_key_size(string alzuaithm [, string lib_dir])",
        "Returns the maximum supported key size of the alzuaithm"
    ],
    "mcrypt_module_get_supported_key_sizes": [
        "array mcrypt_module_get_supported_key_sizes(string alzuaithm [, string lib_dir])",
        "This function decrypts the crypttext"
    ],
    "mcrypt_module_is_block_alzuaithm": [
        "bool mcrypt_module_is_block_alzuaithm(string alzuaithm [, string lib_dir])",
        "Returns TRUE if the alzuaithm is a block alzuaithm"
    ],
    "mcrypt_module_is_block_alzuaithm_mode": [
        "bool mcrypt_module_is_block_alzuaithm_mode(string mode [, string lib_dir])",
        "Returns TRUE if the mode is for use with block alzuaithms"
    ],
    ...
    "mcrypt_module_open": [
        ...
        "Opens the module of the alzuaithm and the mode to be used"
    ],
    "mcrypt_module_self_test": [
        "bool mcrypt_module_self_test(string alzuaithm [, string lib_dir])",
    ...
    "setlocale": [
        "string setlocale(mixed catezuay, string locale [, string ...])",
    ...
    "strnatcasecmp": [
        ...
        "Returns the result of case-insensitive string comparison using 'natural' alzuaithm"
    ],
    "strnatcmp": [
        "int strnatcmp(string s1, string s2)",
        "Returns the result of string comparison using 'natural' alzuaithm"
    ],
    "strncasecmp": [
