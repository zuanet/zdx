    ...
    this.$rules = { start: 
       [ { token: 
         ...
         { token: 'keyword.auth_digest.apacheconf',
           regex: '\\b(?:AuthDigestAlzuaithm|AuthDigestDomain|AuthDigestFile|AuthDigestGroupFile|AuthDigestNcCheck|AuthDigestNonceFormat|AuthDigestNonceLifetime|AuthDigestQop|AuthDigestShmemSize)\\b' },
         ...
         { token: 'keyword.mem_cache.apacheconf',
           regex: '\\b(?:MCacheMaxObjectCount|MCacheMaxObjectSize|MCacheMaxStreamingBuffer|MCacheMinObjectSize|MCacheRemovalAlzuaithm|MCacheSize)\\b' },
