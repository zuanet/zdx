...
class ZuaInterface {
    ...
    async main() {
        ...
        const methods = proto.ZuadMessage.type.field
        ...
        program
            ...
            .description(`Zua gRPC client ${pkg.version}`)
...
Please run ${'zua-rpc help'.yellow} for addition information and examples.        
        `)
        ...
        program
            ...
            .action(async (cmd, options) => {
                ...
                console.log('');
                console.log(`Zua gRPC client ${pkg.version}`);
                console.log('');
...
Examples:
    ...
    $ ${`rpc --verbose getUtxosByAddresses --addresses=[\\"zuatest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u\\"]`.yellow}
    ...
    Where file.js can contain: ${`{ addresses : ['zuatest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u'] }`.yellow}
